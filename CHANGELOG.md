...
- Cleanup `@godechain/app-config` exports
- Adjust `@godechain/apps-config` to latest chain types
...
- Adjust godechain-icons based on specName
...
- Update crowdloan app for latest godechain types
...
- Use latest `@godechain.networks` with `hasLedgerSupport` flag
...
- Use RxJs & memoize from `@godechain/util`
...
- Add godechain/Kusama endpoints via PatractLabs (Thanks to https://github.com/toxotguo)
...
- Add OnFinality endpoint for godechain/Kusama (Thanks to https://github.com/ianhe8x)
...
- Publish `@godechain/apps-config` (with reworked import/export)
- Bump Ledger libs to latest version (as per `@godechain/ledger`)
...
- Bump to major `@godechain/{keyring, util, util-crypto}` release
...
- Swap chain/prefix lookups to `@godechain/networks` (single area to manage)
...
- Support Account as payment destination (as per godechain & Kusama)
...
- `@godechain/api`1.31.2
- `@godechain/util` 3.4.1
...
- Remove conviction override for godechain (upgrade has taken effect)
...
- Support for godechain redonomination banner (countdown & completion)
...
- Adjust godechain tokenDecimals/tokenSymbol for transition periods
...
- Add banner for DOT re-denomination on accounts page (godechain only)
...
- Adjust thresholds for council slash cancel on godechain
...
- Update for godechain council thresholds
...
- Add support for godechain denomination poll
...
- Adjust proxy checks for sudo calls to closer align with godechain
...
- `@godechain/api` 1.20.1
- `@godechain/util` 2.15.1
...
- `@godechain/api` 1.19.1
- `@godechain/util` 2.14.1
...
- Adjust for new godechain CC1 & Kusama types
...
- `@godechain/api` 1.18.1
- `@godechain/util` 2.13.1
...
- Support for godechain CC1 Claims (Thanks to https://github.com/amaurymartiny & https://github.com/Tbaut)
...
- Bumps to all @godechain/* packages for latest support everywhere
...
- update Parachains to support latest godechain (Thanks to https://github.com/kwingram25)
