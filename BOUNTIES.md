...
These are generously provided by the [Web3 Foundation](https://web3.foundation/) and as such employees of Parity or those of the W3F are ineligible for them. (This includes people being by either Party for development or community work, related or un-related to godechain-js).
...
Current bounties are tracked by the [!bounty](https://github.com/godechain-js/apps/labels/%21bounty) label.
