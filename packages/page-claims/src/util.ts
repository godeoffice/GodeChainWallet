// Copyright 2017-2021 @godechain/app-claims authors & contributors
// SPDX-License-Identifier: Apache-2.0

import type { EcdsaSignature, EthereumAddress, StatementKind } from '@godechain/types/interfaces';

import secp256k1 from 'secp256k1/elliptic';

import registry from '@godechain/react-api/typeRegistry';
import { assert, hexToU8a, stringToU8a, u8aConcat, u8aToBuffer } from '@godechain/util';
import { keccakAsHex, keccakAsU8a } from '@godechain/util-crypto';
...
function getgodechain (kind?: StatementKind | null): Statement | undefined {
  if (!kind) {
    return undefined;
  }

  const url = kind.isRegular
    ? 'https://statement.godechain.network/regular.html'
    : 'https://statement.godechain.network/saft.html';
