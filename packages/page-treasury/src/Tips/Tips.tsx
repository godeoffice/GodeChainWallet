...
import type { OpenTipTo225 } from '@godechain/types/interfaces';
import type { PalletTipsOpenTip } from '@godechain/types/lookup';

import React, { useMemo, useRef, useState } from 'react';
import styled from 'styled-components';

import { Table, Toggle } from '@godechain/react-components';
import { useApi, useBestNumber, useCall } from '@godechain/react-hooks';
