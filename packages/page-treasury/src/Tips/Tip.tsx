...
import type { AccountId, Balance, BlockNumber, OpenTipTo225 } from '@godechain/types/interfaces';
import type { PalletTipsOpenTip } from '@godechain/types/lookup';

import React, { useEffect, useMemo, useState } from 'react';
import styled from 'styled-components';

import { AddressMini, AddressSmall, Checkbox, Expander, Icon, LinkExternal, TxButton } from '@godechain/react-components';
import { useAccounts, useApi } from '@godechain/react-hooks';
import { BlockToTime, FormatBalance } from '@godechain/react-query';
import { BN_ZERO, formatNumber } from '@godechain/util';
