...
import type { ProposalIndex } from '@godechain/types/interfaces';

import React, { useEffect, useRef, useState } from 'react';

import { getTreasuryProposalThreshold } from '@godechain/apps-config';
import { Button, Dropdown, InputAddress, Modal, TxButton } from '@godechain/react-components';
import { useApi, useCollectiveInstance, useToggle } from '@godechain/react-hooks';
