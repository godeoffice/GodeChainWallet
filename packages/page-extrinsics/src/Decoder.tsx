// Copyright 2017-2021 @godechain/app-extrinsics authors & contributors
// SPDX-License-Identifier: Apache-2.0

import type { SubmittableExtrinsic, SubmittableExtrinsicFunction } from '@godechain/api/types';
import type { Call } from '@godechain/types/interfaces';

import React, { useCallback, useState } from 'react';

import { Button, Call as CallDisplay, Input, InputAddress, InputExtrinsic, MarkError, Output, TxButton } from '@godechain/react-components';
import { useApi } from '@godechain/react-hooks';
import { BalanceFree } from '@godechain/react-query';
import { assert, isHex } from '@godechain/util';
