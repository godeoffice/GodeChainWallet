...
import type { PropIndex, Proposal } from '@godechain/types/interfaces';

import React, { useMemo, useState } from 'react';

import { Button, ConvictionDropdown, Modal, ProposedAction, TxButton, VoteAccount, VoteValue } from '@godechain/react-components';
