...
import type { Route, Routes } from '@godechain/apps-routing/types';
...
import createRoutes from '@godechain/apps-routing';
import { useAccounts, useApi, useCall, useTeleport } from '@godechain/react-hooks';
...
function createExternals (t: TFunction): ItemRoute[] {
  return [
    {
      href: 'https://github.com/godechain-js/apps',
      icon: 'code-branch',
      name: 'github',
      text: t<string>('nav.github', 'GitHub', { ns: 'apps-routing' })
    },
    {
      href: 'https://wiki.godechain.network',
      icon: 'book',
      name: 'wiki',
