...
import type { BareProps as Props, ThemeDef } from '@godechain/react-components/types';

import React, { useContext, useMemo } from 'react';
import styled, { ThemeContext } from 'styled-components';

import AccountSidebar from '@godechain/app-accounts/Sidebar';
import { getSystemColor } from '@godechain/apps-config';
import GlobalStyle from '@godechain/react-components/styles';
import { useApi } from '@godechain/react-hooks';
import Signer from '@godechain/react-signer';
