        ...
        },
        {
          ...
          use: [
            require.resolve('thread-loader'),
            {
              ...
              options: require('@godechain/dev/config/babel-config-webpack.cjs')
            }
          ]
        },
        {
    ...
    optimization: {
      ...
      splitChunks: {
        cacheGroups: {
          ...
          ...mapChunks('godechain', [
            /* 00 */ /node_modules\/@godechain\/(wasm)/,
            /* 01 */ /node_modules\/(@godechain\/(api|metadata|rpc|types))/,
            /* 02 */ /node_modules\/(@godechain\/(extension|keyring|networks|react|ui|util|vanitygen|x-)|@acala-network|@edgeware|@laminar|@ledgerhq|@open-web3|@sora-substrate|@subsocial|@zondax|edgeware)/
          ]),
          ...mapChunks('react', [
