// Copyright 2017-2021 @godechain/app-calendar authors & contributors
// SPDX-License-Identifier: Apache-2.0

import type BN from 'bn.js';
import type { DeriveCollectiveProposal, DeriveDispatch, DeriveReferendumExt, DeriveSessionProgress } from '@godechain/api-derive/types';
import type { Option } from '@godechain/types';
import type { BlockNumber, EraIndex, LeasePeriodOf, Scheduled, UnappliedSlash } from '@godechain/types/interfaces';
import type { ITuple } from '@godechain/types/types';
import type { EntryInfo, EntryInfoTyped, EntryType } from './types';

import { useEffect, useState } from 'react';

import { useLeaseRangeMax } from '@godechain/app-parachains/useLeaseRanges';
import { createNamedHook, useApi, useBestNumber, useBlockTime, useCall } from '@godechain/react-hooks';
import { BN_ONE, BN_ZERO } from '@godechain/util';
