...
import { KeyringPair } from '@godechain/keyring/types';
import { charlieSigner, daveSigner, eveSigner, ferdieSigner } from '@godechain/test-support/keyring';
import { execute } from '@godechain/test-support/transaction';
import { Hash } from '@godechain/types/interfaces';
