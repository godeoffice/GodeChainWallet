...
import type { Registrar } from '@godechain/react-hooks/types';
import type { ProxyDefinition, RegistrationJudgement, Voting } from '@godechain/types/interfaces';

import BN from 'bn.js';

import { H256, Multisig } from '@godechain/types/interfaces';
