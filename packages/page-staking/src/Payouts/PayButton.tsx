...
import type { EraIndex } from '@godechain/types/interfaces';
...
import { AddressMini, Button, InputAddress, Modal, Static, TxButton } from '@godechain/react-components';
import { useApi, useToggle, useTxBatch } from '@godechain/react-hooks';
