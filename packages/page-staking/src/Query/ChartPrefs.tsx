...
import type { DeriveStakerPrefs } from '@godechain/api-derive/types';
import type { ChartInfo, LineDataEntry, Props } from './types';

import BN from 'bn.js';
import React, { useMemo, useRef } from 'react';

import { Chart, Spinner } from '@godechain/react-components';
import { useApi, useCall } from '@godechain/react-hooks';
import { BN_BILLION } from '@godechain/util';
