// Copyright 2017-2021 @godechain/app-poll authors & contributors
// SPDX-License-Identifier: Apache-2.0

import type { Approvals, Balance, BlockNumber } from '@godechain/types/interfaces';
...
import { Button, Columar, InputAddress, Progress, Spinner, Tabs, Toggle, TxButton } from '@godechain/react-components';
import { useApi, useBestNumber, useCallMulti } from '@godechain/react-hooks';
import { BlockToTime, FormatBalance } from '@godechain/react-query';
import { BN_MILLION, BN_ONE, BN_ZERO, bnMax, formatBalance, formatNumber } from '@godechain/util';
    ...
    <main className={className}>
      ...
      <div className='pollContainer'>
        ...
        <article className='keepAlive'>
          <p><Trans key='poll1'>The godechain DOT denomination vote: Seventy-two hours after the DOT token becomes transferable, the most popular option from this poll will decide the denomination used for the DOT token.</Trans></p>
          ...
          <p><Trans key='poll3'>Please see the <a href='https://medium.com/godechain-network/the-first-godechain-vote-1fc1b8bd357b' rel='noreferrer' target='_blank'>Medium article </a> for more information</Trans></p>
          {canVote && (
