...
import type { BalanceOf } from '@godechain/types/interfaces';
import type { OwnedId, OwnerInfo } from '../types';

import BN from 'bn.js';
import React, { useCallback, useMemo, useState } from 'react';

import { InputAddress, InputBalance, InputFile, InputNumber, Modal, TxButton } from '@godechain/react-components';
import { useApi } from '@godechain/react-hooks';
import { compactAddLength } from '@godechain/util';
