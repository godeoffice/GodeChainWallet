...
import type { AccountId, Hash, Proposal, ProposalIndex } from '@godechain/types/interfaces';

import React, { useState } from 'react';

import { Button, MarkWarning, Modal, ProposedAction, TxButton, VoteAccount } from '@godechain/react-components';
