...
import { getSlashProposalThreshold } from '@godechain/apps-config';
import { Button, Dropdown, Input, InputAddress, Modal, TxButton } from '@godechain/react-components';
import { useApi, useAvailableSlashes, useCollectiveInstance, useToggle } from '@godechain/react-hooks';
