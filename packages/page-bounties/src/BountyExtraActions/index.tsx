...
import { Button, Menu, Popup } from '@godechain/react-components';
import { useCollectiveMembers, useToggle } from '@godechain/react-hooks';
import { BlockNumber, BountyIndex, BountyStatus } from '@godechain/types/interfaces';
