...
import { createNamedHook, useApi, useBestNumber, useCall } from '@godechain/react-hooks';
import { BalanceOf, BlockNumber, BountyIndex } from '@godechain/types/interfaces';
