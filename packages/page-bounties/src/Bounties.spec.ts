...
import type { BountyIndex, BountyStatus } from '@godechain/types/interfaces';
import type { PalletBountiesBounty } from '@godechain/types/lookup';
...
import { createAugmentedApi } from '@godechain/test-support/api';
import { balanceOf } from '@godechain/test-support/creation/balance';
import { BountyFactory } from '@godechain/test-support/creation/bounties/bountyFactory';
import { proposalFactory } from '@godechain/test-support/creation/treasury/proposalFactory';
import { mockHooks } from '@godechain/test-support/hooks/mockHooks';
...
jest.mock('@godechain/react-hooks/useTreasury', () => ({
  useTreasury: () => mockHooks.treasury
}));

jest.mock('@godechain/react-hooks/useCollectiveInstance', () => ({
  useCollectiveInstance: () => 'council'
}));

jest.mock('@godechain/react-hooks/useCollectiveMembers', () => ({
  useCollectiveMembers: () => mockHooks.members
}));

jest.mock('@godechain/react-hooks/useBlockTime', () => ({
