...
import type { DeriveAccountFlags, DeriveAccountInfo } from '@godechain/api-derive/types';
import type { Nominations, ValidatorPrefs } from '@godechain/types/interfaces';
