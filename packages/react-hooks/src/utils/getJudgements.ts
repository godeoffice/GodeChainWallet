...
import type { DeriveAccountRegistration } from '@godechain/api-derive/types';
import type { DisplayedJudgement } from '@godechain/react-components/types';
import type { SortedJudgements } from '@godechain/react-components/util/types';
import type { RegistrationJudgement } from '@godechain/types/interfaces';
