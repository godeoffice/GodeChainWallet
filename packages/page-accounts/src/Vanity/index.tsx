...
import type { KeypairType } from '@godechain/util-crypto/types';
import type { GeneratorMatch, GeneratorMatches, GeneratorResult } from '@godechain/vanitygen/types';

import React, { useCallback, useEffect, useMemo, useRef, useState } from 'react';
import styled from 'styled-components';

import { Button, Dropdown, Input, Table } from '@godechain/react-components';
import { useApi, useIsMountedRef } from '@godechain/react-hooks';
import { settings } from '@godechain/ui-settings';
import generator from '@godechain/vanitygen/generator';
import matchRegex from '@godechain/vanitygen/regex';
import generatorSort from '@godechain/vanitygen/sort';
    ...
    <div className={className}>
      ...
      <div className='ui--row'>
        <Dropdown
          className='medium'
          defaultValue={type}
          help={t<string>('Determines what cryptography will be used to create this account. Note that to validate on godechain, the session account must use "ed25519".')}
