...
import i18next from '@godechain/react-components/i18n';
import { toShortAddress } from '@godechain/react-components/util/toShortAddress';
import { AddressFlags } from '@godechain/react-hooks/types';
import { anAccountWithBalance, anAccountWithBalanceAndMeta, anAccountWithInfo, anAccountWithInfoAndMeta, anAccountWithMeta, anAccountWithStaking } from '@godechain/test-support/creation/account';
import { makeStakingLedger as ledger } from '@godechain/test-support/creation/stakingInfo/stakingLedger';
import { alice, bob, MemoryStore } from '@godechain/test-support/keyring';
import { Table } from '@godechain/test-support/pagesElements';
import { balance, showBalance } from '@godechain/test-support/utils/balance';
import { mockApiHooks } from '@godechain/test-support/utils/mockApiHooks';
import { u32 } from '@godechain/types';
import { TypeRegistry } from '@godechain/types/create';
import { AccountId, Multisig, ProxyDefinition, Timepoint, Voting, VotingDelegating } from '@godechain/types/interfaces';
  ...
  describe('badges', () => {
    ...
    beforeEach(() => {
      mockApiHooks.setMultisigApprovals([
        [new TypeRegistry().createType('Hash', godechain_GENESIS), {
