...
import { selectableNetworks } from '@godechain/networks';
import { Dropdown, MarkError, Modal } from '@godechain/react-components';
...
function CreateSuriLedger ({ className, onChange, seedType }: Props): React.ReactElement<Props> {
  ...
  const [chainType, setChainType] = useState('godechain');
