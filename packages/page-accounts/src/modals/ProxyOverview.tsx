...
import { BatchWarning, Button, Dropdown, InputAddress, InputBalance, MarkError, Modal, TxButton } from '@godechain/react-components';
import { useApi, useTxBatch } from '@godechain/react-hooks';
...
function getProxyTypeInstance (api: ApiPromise, index = 0): NodeRuntimeProxyType {
  // This is not perfect, but should work for `{Kusama, Node, godechain}RuntimeProxyType`
