...
import type { AccountInfoWithProviders, AccountInfoWithRefCount } from '@godechain/types/interfaces';

import React, { useEffect, useState } from 'react';
import styled from 'styled-components';

import { checkAddress } from '@godechain/phishing';
import { InputAddress, InputBalance, MarkError, MarkWarning, Modal, Toggle, TxButton } from '@godechain/react-components';
import { useApi, useCall } from '@godechain/react-hooks';
import { Available } from '@godechain/react-query';
import { BN_HUNDRED, BN_ZERO, isFunction } from '@godechain/util';
