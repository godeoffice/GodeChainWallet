...
import type { NetworkSpecsStruct } from '@godechain/ui-settings/types';
import type { ChainInfo, ChainType } from '../types';

import React, { useCallback, useEffect, useReducer, useRef, useState } from 'react';
import styled from 'styled-components';

import { ChainImg, Input, QrNetworkSpecs, Spinner, Table } from '@godechain/react-components';
import { useApi, useDebounce } from '@godechain/react-hooks';
...
// TODO-MOONBEAM: update NetworkSpecsStruct in @godechain/ui-settings/types
    ...
    >
      ...
      <tr>
        <td>
          ...
          <Input
            className='full'
            help={t<string>('Unit decides the name of 1 unit token, e.g. "DOT" for godechain')}
            isDisabled
            label={t<string>('Unit')}
